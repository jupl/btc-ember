...
## About
Cinder Brunch uses the [Ember.js](http://emberjs.com/) framework with [CoffeeScript](http://coffeescript.org/). With this skeleton, one does not need to worry about using `require` statements when it comes to Ember modules. This skeleton is not styling dependent, allowing one to use any style language they want.
